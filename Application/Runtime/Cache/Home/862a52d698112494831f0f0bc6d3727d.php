			...
			<div class="summary">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<!--第一个是商品logo-->
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $viewPath.$info['sm_logo']; ?>',largeimage: '<?php echo $viewPath.$info['sm_logo']; ?>'}"><?php showImage($info['sm_logo']);?></a>
								</li>
								<!--第2个图片 循环相册里面的商品图片-->
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>购买价：</span> <strong style="font-size: 25px;" id="member_price"></strong> <a href="">(降价通知)</a></li>
								...
								<dl>
									...
									<dd>
										...
										<a <?php if($k1 == 0) echo 'class="selected"'; ?> href="javascript:;"><?php echo $v1['attr_value'] ;?>
											<input type="radio" name="color" value="<?php echo $v1['attr_value'] ;?>" <?php if($k1 == 0) echo 'checked="checked"'; ?> /></a>
										<?php endforeach; ?>
									</dd>
								</dl>
							</li>
